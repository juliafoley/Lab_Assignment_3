...
There will be a larger number of non-smoking, non-smokers who self identify as in excellent, very good and good health when as compared to the smoking exercisers and the non-smoking, non-exercisers. 
  ...
  **Findings**
My hypothesis turned out to be correct. As conventional wisdom predicted, the largest change in self-reported excellent, very good and good health, came from the addition of exercise to a non-smoker or smoker's routine.
...
**Individual**
  I, Andres Acevedo, explored the relationship between age and weight of smokers and non smokers. After plotting age vs weight and segmenting by genhlth, I realized there were no valuable differences in the rate at which smokers and non smokers gain weight over time. I then decided that the most reliable data was the self reporting of health status. I ended up building a plot comparing the self reported health status of non-smoking non-exercisers, non-smoking exercisers, and all other groups. I used conventional wisdom to predict that the healthiest group would be the non-smoking non-exercisers. 

**Team**
As a member of the P-Hackers, I helped come up with the research question. I also discussed all relationships between smoking and weight with my teammates to help us come up with our final plot. 
